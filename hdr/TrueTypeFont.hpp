...
namespace Roole
{
  ...
  //!
  //! This function does not yet support Roole::FontFlags, and consequently, custom TTF fonts do
  ...
  //! 2. Maybe Roole should accept filename patterns like "LibreBaskerville-*.ttf" as the font
  //!    name and then replace the * with "Regular", "Bold", "Italic" etc.?
  //! 3. As a last resort, Roole could implement faux bold and faux italics. I think faux
