...
Roole::LargeImageData::LargeImageData(const Bitmap& source, int tile_width, int tile_height,
...
void Roole::LargeImageData::draw(double x1, double y1, Color c1,
...
unique_ptr<Roole::ImageData>
    Roole::LargeImageData::subimage(int left, int top, int width, int height) const
{
...
Roole::Bitmap Roole::LargeImageData::to_bitmap() const
{
...
void Roole::LargeImageData::insert(const Bitmap& bitmap, int at_x, int at_y)
{
  int y = 0;
  for (int ty = 0; ty < tiles_y; ++ty) {
    int x = 0;
