...
string Roole::TextInput::text() const
{
...
void Roole::TextInput::set_text(const string& text)
{
  pimpl->text = text;
...
unsigned Roole::TextInput::caret_pos() const
{
  return pimpl->caret_pos;
}

void Roole::TextInput::set_caret_pos(unsigned caret_pos)
{
  pimpl->caret_pos = caret_pos;
}

unsigned Roole::TextInput::selection_start() const
{
  return pimpl->selection_start;
}

void Roole::TextInput::set_selection_start(unsigned selection_start)
{
  pimpl->selection_start = selection_start;
}

#ifndef ROOLE_IS_IPHONE
bool Roole::TextInput::feed_sdl_event(void* event)
{
...
void Roole::TextInput::insert_text(string text)
{
  pimpl->insert_text(text);
}

void Roole::TextInput::delete_forward()
{
  pimpl->delete_forward();
}

void Roole::TextInput::delete_backward()
{
  pimpl->delete_backward();
}
