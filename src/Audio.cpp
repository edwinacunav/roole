...
Roole::Channel Roole::Sample::play(double volume, double speed, bool looping) const
{
    return play_pan(0, volume, speed, looping);
}

Roole::Channel Roole::Sample::play_pan(double pan, double volume, double speed, bool looping) const
{
