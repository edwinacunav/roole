...
namespace
{
  ...
  HSV color_to_hsv(const Color& c)
  {
...
Color Color::from_ahsv(Channel alpha, double h, double s, double v)
...
Color Roole::interpolate(Color a, Color b, double weight)
{
...
Color Roole::multiply(Color a, Color b)
{
