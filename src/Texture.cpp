...
Roole::Texture::Texture(unsigned width, unsigned height, bool retro)
...
unsigned Roole::Texture::width() const
{
  return allocator_.width();
}

unsigned Roole::Texture::height() const
{
  return allocator_.height();
}

GLuint Roole::Texture::tex_name() const
{
  return tex_name_;
}

bool Roole::Texture::retro() const
{
  return retro_;
}

unique_ptr<Roole::TexChunk> Roole::Texture::try_alloc(const Bitmap& bmp, unsigned padding)
{
...
void Roole::Texture::block(unsigned x, unsigned y, unsigned width, unsigned height)
{
  allocator_.block(x, y, width, height);
}

void Roole::Texture::free(unsigned x, unsigned y, unsigned width, unsigned height)
{
  allocator_.free(x, y, width, height);
}

Roole::Bitmap Roole::Texture::to_bitmap(unsigned x, unsigned y, unsigned width, unsigned height) const
{
#ifdef ROOLE_IS_OPENGLES
