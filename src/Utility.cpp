...
u32string Roole::utf8_to_composed_utc4(const string& utf8)
{
    u32string utc4;
...
bool Roole::has_extension(const string& filename, const char* extension)
{
...
#if defined(ROOLE_IS_UNIX) && !defined(ROOLE_IS_MAC)
